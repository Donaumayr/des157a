( function(){
    ...
    function checkWinningCondition() {
        if(gameData.score[gameData.index] > gameData.gameEnd) {
            ...
            game.innerHTML = `<h1 id="win">${gameData.players[gameData.index]} wins with</h1><h1 id="win2"><b>${gameData.score[gameData.index]} points!</b></h1>`;
            winSound.play();
            actionArea.style.display = 'none';
            let q = document.createElement("button");
            q.id = "restart";
            q.textContent = 'Start a New Game';
            game.appendChild(q);
            ...
            //document.getElementById('topcontrol').style.justifyContent = 'center';
        }else {
            //show current score
            showCurrentScore();
        }
